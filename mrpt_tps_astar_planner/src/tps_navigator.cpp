...
// TODO(jlbc): Move this class upstream to mrpt_path_planning repo?
...
#include "mrpt_tps_astar_planner/tps_navigator.h"
	...
	const std::optional<TNodeID>& startingFromNodeID)
{
	...
	_.pathPlannerFuture = pathPlannerPool_.enqueue(
		&TPS_Navigator::path_planner_function, this, ppi);
...
TPS_Navigator::AboutToReachWpInfo
	TPS_Navigator::internal_check_about_to_reach_stop_wp()
{
